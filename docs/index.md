...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-1](https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-1)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-1-gitops](https://github.com/rhdh-JslYoon-org/agentic-audio-text-sep11-1-gitops)

# **Usage**

To access the agentic-audio-text-sep11-1 application that was deployed using the Software Template, complete the following instructions:
