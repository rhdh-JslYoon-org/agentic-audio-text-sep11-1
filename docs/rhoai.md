...
3) Access the `workbench` named `agentic-audio-text-sep11-1-notebook`.
...
5) In the terminal, run `cd agentic-audio-text-sep11-1` to navigate to your sample app's directory.
